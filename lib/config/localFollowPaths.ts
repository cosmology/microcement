...
export const LOCAL_FOLLOW_PATHS: LocalFollowPath[] = [
  ...
  },
  {
    ...
    scene_design_config_id: 'd4e5f6a7-b8c9-0123-4567-89abcdef0123', // Client config ID
    path_name: 'current',
    camera_points: [
      { x: 52.789, y: 5, z: 7.394 },
      { x: 26.431, y: 5, z: 4.865 },
      { x: 7.035, y: 5, z: -4.16 },
      { x: 1.414, y: 5, z: 1.651 },
      { x: 15.934, y: 5, z: 8.433 },
      { x: 10.723, y: 5, z: 3.854 },
      { x: 3.228, y: 6.5, z: -0.735 },
      { x: 1.791, y: 6.75, z: -5.642 },
      { x: 11.761, y: 7, z: -5.575 }
    ],
    look_at_targets: [
      { x: 2.041, y: 0, z: -12.068 },
      { x: -14.408, y: 0, z: -41.196 },
      { x: -45.014, y: 0, z: -44.588 },
      { x: -69.435, y: 0, z: -57.641 },
      { x: 38.766, y: 0, z: -3.977 },
      { x: 74.895, y: 0, z: 41.866 },
      { x: -32.177, y: 0, z: -47.776 },
      { x: 0.632, y: 0, z: -33.329 },
      { x: 34.312, y: 0, z: -22.945 }
    ],
    is_active: true
  }
];
